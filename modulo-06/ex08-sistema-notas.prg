FUNCTION Main()
   ...
   FOR nI := 1 TO nTotalAlunos
      ...
      // Leitura das 4 notas via fun├º├úo auxiliar
   ...
   // RELAT├ôRIO 2: REPROVADOS (M├®dia < 7.0)
...
// --- FUN├ç├òES AUXILIARES DE SUPORTE ---

// L├¬ e garante uma nota no intervalo [0, 10]
...
// Valida se a string cont├®m apenas d├¡gitos
